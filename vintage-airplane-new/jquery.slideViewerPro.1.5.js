...
// slideViewerPro options (defaults)
			...
			buttonsWidth: 25, // the width of the prev/next buttons that commands the thumbnails
			galBorderColor: "#000", // the border color around the main images  
			thumbsBorderColor: "#8B7052", // the border color of the thumbnails but not the current one
			thumbsActiveBorderColor: "#470606", // the border color of the current thumbnail
			buttonsTextColor: "#FFF", //the color of the optional text in leftButtonInner/rightButtonInner
			...
			thumbsPercentReduction: 15, // the percentual reduction of the thumbnails in relation to the original
			thumbsVis: true, // with this option set to false, the whole UI (thumbs and buttons) are not visible
			leftButtonInner: "<", //could be an image "<img src='images/larw.gif' />" or an escaped char as "&larr";
			rightButtonInner: ">", //could be an image or an escaped char as "&rarr";
//			leftButtonInner: "<img src='images/leftArrow.png'>", //could be an image "<img src='images/larw.gif' />" or an escaped char as "&larr";
//			rightButtonInner: "<img src='images/rightArrow.png'>", //could be an image or an escaped char as "&rarr";
			...
			typoFullOpacity: 0.8, // the opacity for typographic info. 1 means fully visible.
